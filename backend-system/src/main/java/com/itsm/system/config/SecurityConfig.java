    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/incidents/alerts")).permitAll()
                ...
                .requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/customer/**")).hasAnyRole("OPERATOR", "ADMIN")
